...
var ResultsTable = function ResultsTable(_ref) {
  ...
  parseCSV('/csv/animals.csv').then(function (data) {
    animalsSet = new Set(data.map(function (animal) {
      return animal.toLowerCase();
    }));
    console.log("Parsed Animals:", Array.from(animalsSet)); // Log inside .then()
  });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            console.log("Formatted Answer: ".concat(formattedAnswer));

            if (!(category === 'animals' && animalsSet.has(formattedAnswer))) {
              _context3.next = 8;
              break;
            }

            console.log("".concat(formattedAnswer, " is found in the set."));
...
//# sourceMappingURL=index.js.53209d2a36f953188e81.hot-update.js.map