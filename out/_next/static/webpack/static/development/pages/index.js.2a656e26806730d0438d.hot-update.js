    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getScoreFromAPI$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            console.log("'".concat(formattedAnswer, "' is not found in the animal set."));
          ...
          case 12:
            ...
            if (!namesSet.has(formattedAnswer)) {
              _context3.next = 18;
              break;
            }

            console.log("'".concat(formattedAnswer, "' is a valid name."));
            return _context3.abrupt("return", 10);

          case 18:
            console.log("'".concat(formattedAnswer, "' is not found in the names set."));
          ...
          case 21:
            ...
            if (!thingsSet.has(formattedAnswer)) {
              _context3.next = 27;
              break;
            }

            console.log("'".concat(formattedAnswer, "' is a valid thing."));
            return _context3.abrupt("return", 10);

          case 27:
            console.log("'".concat(formattedAnswer, "' is not found in the things set."));
          ...
          case 30:
            ...
            if (!placesSet.has(formattedAnswer)) {
              _context3.next = 36;
              break;
            }

            console.log("'".concat(formattedAnswer, "' is a valid place."));
            return _context3.abrupt("return", 10);

          case 36:
            console.log("'".concat(formattedAnswer, "' is not found in the places set."));
...
//# sourceMappingURL=index.js.2a656e26806730d0438d.hot-update.js.map