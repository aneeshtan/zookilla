...
var ResultsTable = function ResultsTable(_ref) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({
    ...
    tv_showsSet: new Set()
      ...
      gameData = _useState3[0],
      setGameData = _useState3[1];
    ...
    Promise.all(categories.map(function (category) {
      return parseCSV("/csv/".concat(category, ".csv")).then(function (data) {
        setGameData(function (prevGameData) {
          return _objectSpread({}, prevGameData, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, "".concat(category, "Set"), new Set(data.map(function (item) {
            return item.toLowerCase().trim();
          }))));
        });
      });
    }));
  }, ["".concat(category, "Set")]); // Empty dependency array to run only once on mount

  var scoreEntriesAI = function scoreEntriesAI() {
    var newScores, _iterator, _step, _category, _iterator2, _step2, user, answer, score;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            user = _step2.value;
            answer = user.responses[round][_category];
            ...
            _context2.next = 18;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(getScoreFromAPI(_category, answer));

          case 18:
            score = _context2.sent;
            newScores[user.id] = _objectSpread({}, newScores[user.id] || {}, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, _category, score));
...
//# sourceMappingURL=index.js.fe0cc83a8a1f2ed7f8f5.hot-update.js.map